function [Y_act]=forwardIntegrate_vardt_zoh(U_act,x0,dt)
...
T_act=0:dt:(size(U_act,1)-1)*dt;
T=0:0.01:(length(T_act)-1)*dt;
U=interp1(T_act,U_act,T,'previous');
%constants
W=13720;
Nw=2;
f=0.01;
