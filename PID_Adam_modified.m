...
t_sim=0:0.01:200;
drift_control_step=100;%Simulate ode45 open loop at these many time steps from start
...
while (exit_flag==0)
    ...
    if r > 10
     ...
     if rem(k,drift_control_step)==0
        x= forwardIntegrateControlInput(U,x0);        
    end
